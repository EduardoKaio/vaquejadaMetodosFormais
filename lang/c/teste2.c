 ...
 *
 * Cenario:
 *   - 4 senhas compradas (uma por vaqueiro)
...
void executar_teste_2(void) {
  ...
  Controle_Torneio__comprar_senha(4, 4);
  ...
  /* --- Senha 1: dois valeu_boi -> classificada --- */
  ...
  /* --- Senha 2: dois valeu_boi -> classificada --- */
  ...
  /* --- Senha 4: valeu_boi + zero_boi -> eliminada --- */
