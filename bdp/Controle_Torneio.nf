...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Machine(Controle_Torneio))==(dono_senha,estado_senha,bois_corridos,fila_geral,fila_disputa_atual,fila_disputa_proxima,eliminados_nesta_rodada:={},{},{},<>,<>,<>,<>;fase_atual,rodizio_atual,idx_correndo,torneio_iniciado,ultimo_rodizio_iniciado,racha_sem_finalizar,premiacao_individual,premiacao_vagas,premiacao_total_atual,colocacao,posicao_atual:=classificacao,<>,1,FALSE,FALSE,FALSE,VAQUEIROS*{0},0,PREMIO_TOTAL,{},0);
...
THEORY ListSubstitutionX IS
  ...
  List_Substitution(Machine(Controle_Torneio),iniciar_ultimo_rodizio)==(rodizio_atual <-- extrair_lote_rodizio || idx_correndo:=1 || ultimo_rodizio_iniciado:=TRUE || torneio_iniciado:=TRUE);
...
THEORY ListOfIdsX IS
  List_Of_Ids(Machine(Controle_Torneio)) == (? | ? | posicao_atual,colocacao,premiacao_total_atual,premiacao_vagas,premiacao_individual,racha_sem_finalizar,ultimo_rodizio_iniciado,torneio_iniciado,idx_correndo,rodizio_atual,fase_atual | eliminados_nesta_rodada,fila_disputa_proxima,fila_disputa_atual,fila_geral,bois_corridos,estado_senha,dono_senha | comprar_senha,desistir_senha,transferir_senha,iniciar_rodizio,iniciar_ultimo_rodizio,chamar_para_pista,correr_boi_classificacao,iniciar_fase_disputa,correr_boi_disputa,iniciar_nova_rodada_disputa,finalizar_sem_vencedor,rachar_sem_finalizar,rachar_premio,declarar_campeao_unico,observar_torneio_encerrado,consultar_status_senha,consultar_dono,total_senhas_vendidas,consultar_bois_derrubados | ? | seen(Machine(Contexto_Vaquejada)),included(Machine(Gerenciador_Senhas)) | ? | Controle_Torneio);
