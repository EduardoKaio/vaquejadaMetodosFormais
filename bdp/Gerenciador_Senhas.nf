...
THEORY ListVariablesX IS
  ...
  Local_List_Variables(Machine(Gerenciador_Senhas))==(categoria_vaqueiro,bois_corridos,estado_senha,dono_senha);
  List_Variables(Machine(Gerenciador_Senhas))==(categoria_vaqueiro,bois_corridos,estado_senha,dono_senha);
  External_List_Variables(Machine(Gerenciador_Senhas))==(categoria_vaqueiro,bois_corridos,estado_senha,dono_senha)
END
&
...
THEORY ListInitialisationX IS
  Expanded_List_Initialisation(Machine(Gerenciador_Senhas))==(dono_senha,estado_senha,bois_corridos,categoria_vaqueiro:={},{},{},{});
  Context_List_Initialisation(Machine(Gerenciador_Senhas))==(skip);
  List_Initialisation(Machine(Gerenciador_Senhas))==(dono_senha:={} || estado_senha:={} || bois_corridos:={} || categoria_vaqueiro:={})
END
&
...
THEORY ListInputX IS
  List_Input(Machine(Gerenciador_Senhas),cadastrar_senha)==(vv,ss,cat);
  List_Input(Machine(Gerenciador_Senhas),atualizar_status)==(ss,novo_status);
  List_Input(Machine(Gerenciador_Senhas),atualizar_dono)==(ss,novo_vaqueiro,cat);
...
THEORY ListHeaderX IS
  List_Header(Machine(Gerenciador_Senhas),cadastrar_senha)==(cadastrar_senha(vv,ss,cat));
  List_Header(Machine(Gerenciador_Senhas),atualizar_status)==(atualizar_status(ss,novo_status));
  List_Header(Machine(Gerenciador_Senhas),atualizar_dono)==(atualizar_dono(ss,novo_vaqueiro,cat));
...
THEORY ListPreconditionX IS
  List_Precondition(Machine(Gerenciador_Senhas),cadastrar_senha)==(vv: NAT1 & ss: NAT1 & cat: CATEGORIAS & ss/:dom(dono_senha) & card(dom(dono_senha))<LIMITE_SENHAS & (vv: dom(categoria_vaqueiro) => categoria_vaqueiro(vv) = cat));
  List_Precondition(Machine(Gerenciador_Senhas),atualizar_status)==(ss: NAT1 & ss: dom(estado_senha) & novo_status: STATUS_SENHA);
  List_Precondition(Machine(Gerenciador_Senhas),atualizar_dono)==(ss: NAT1 & novo_vaqueiro: NAT1 & cat: CATEGORIAS & ss: dom(dono_senha) & cat = categoria_vaqueiro(dono_senha(ss)) & (novo_vaqueiro: dom(categoria_vaqueiro) => categoria_vaqueiro(novo_vaqueiro) = cat));
  List_Precondition(Machine(Gerenciador_Senhas),registrar_valeu_boi)==(ss: NAT1 & ss: dom(estado_senha) & ss: dom(bois_corridos) & bois_corridos(ss)<BOIS_PARA_CLASSIFICAR & novo_status: STATUS_SENHA);
  List_Precondition(Machine(Gerenciador_Senhas),incrementar_boi)==(ss: NAT1 & ss: dom(bois_corridos) & bois_corridos(ss)<BOIS_PARA_CLASSIFICAR);
...
THEORY ListSubstitutionX IS
  ...
  Expanded_List_Substitution(Machine(Gerenciador_Senhas),incrementar_boi)==(ss: NAT1 & ss: dom(bois_corridos) & bois_corridos(ss)<BOIS_PARA_CLASSIFICAR | bois_corridos:=bois_corridos<+{ss|->bois_corridos(ss)+1});
  Expanded_List_Substitution(Machine(Gerenciador_Senhas),registrar_valeu_boi)==(ss: NAT1 & ss: dom(estado_senha) & ss: dom(bois_corridos) & bois_corridos(ss)<BOIS_PARA_CLASSIFICAR & novo_status: STATUS_SENHA | bois_corridos,estado_senha:=bois_corridos<+{ss|->bois_corridos(ss)+1},estado_senha<+{ss|->novo_status});
  Expanded_List_Substitution(Machine(Gerenciador_Senhas),atualizar_dono)==(ss: NAT1 & novo_vaqueiro: NAT1 & cat: CATEGORIAS & ss: dom(dono_senha) & cat = categoria_vaqueiro(dono_senha(ss)) & (novo_vaqueiro: dom(categoria_vaqueiro) => categoria_vaqueiro(novo_vaqueiro) = cat) | dono_senha,categoria_vaqueiro:=dono_senha<+{ss|->novo_vaqueiro},categoria_vaqueiro<+{novo_vaqueiro|->cat});
  Expanded_List_Substitution(Machine(Gerenciador_Senhas),atualizar_status)==(ss: NAT1 & ss: dom(estado_senha) & novo_status: STATUS_SENHA | estado_senha:=estado_senha<+{ss|->novo_status});
  Expanded_List_Substitution(Machine(Gerenciador_Senhas),cadastrar_senha)==(vv: NAT1 & ss: NAT1 & cat: CATEGORIAS & ss/:dom(dono_senha) & card(dom(dono_senha))<LIMITE_SENHAS & (vv: dom(categoria_vaqueiro) => categoria_vaqueiro(vv) = cat) | dono_senha,estado_senha,bois_corridos,categoria_vaqueiro:=dono_senha<+{ss|->vv},estado_senha<+{ss|->na_espera},bois_corridos<+{ss|->0},categoria_vaqueiro<+{vv|->cat});
  List_Substitution(Machine(Gerenciador_Senhas),cadastrar_senha)==(dono_senha(ss):=vv || estado_senha(ss):=na_espera || bois_corridos(ss):=0 || categoria_vaqueiro(vv):=cat);
  List_Substitution(Machine(Gerenciador_Senhas),atualizar_status)==(estado_senha(ss):=novo_status);
  List_Substitution(Machine(Gerenciador_Senhas),atualizar_dono)==(dono_senha(ss):=novo_vaqueiro || categoria_vaqueiro(novo_vaqueiro):=cat);
...
&
THEORY ListSetsX IS
  Set_Definition(Machine(Gerenciador_Senhas),CATEGORIAS)==({profissional,amador});
  Context_List_Enumerated(Machine(Gerenciador_Senhas))==(FASES,STATUS_SENHA,JULGAMENTO,CATEGORIAS);
  Context_List_Defered(Machine(Gerenciador_Senhas))==(?);
  Context_List_Sets(Machine(Gerenciador_Senhas))==(FASES,STATUS_SENHA,JULGAMENTO,CATEGORIAS);
...
THEORY ListPropertiesX IS
  ...
  Context_List_Properties(Machine(Gerenciador_Senhas))==(LIMITE_SENHAS: NAT1 & LIMITE_SENHAS = 100 & BOIS_PARA_CLASSIFICAR: NAT1 & BOIS_PARA_CLASSIFICAR = 3 & VAQUEIROS = NAT1 & SENHAS = NAT1 & FASES: FIN(INTEGER) & not(FASES = {}) & STATUS_SENHA: FIN(INTEGER) & not(STATUS_SENHA = {}) & JULGAMENTO: FIN(INTEGER) & not(JULGAMENTO = {}) & CATEGORIAS: FIN(INTEGER) & not(CATEGORIAS = {}));
...
THEORY VariablesEnvX IS
  Variables(Machine(Gerenciador_Senhas)) == (Type(categoria_vaqueiro) == Mvl(SetOf(btype(INTEGER,?,?)*etype(CATEGORIAS,?,?)));Type(bois_corridos) == Mvl(SetOf(btype(INTEGER,?,?)*btype(INTEGER,?,?)));Type(estado_senha) == Mvl(SetOf(btype(INTEGER,?,?)*etype(STATUS_SENHA,?,?)));Type(dono_senha) == Mvl(SetOf(btype(INTEGER,?,?)*btype(INTEGER,?,?))))
END
&
THEORY OperationsEnvX IS
  Operations(Machine(Gerenciador_Senhas)) == (Type(finalizar_torneio) == Cst(No_type,No_type);Type(preparar_disputa) == Cst(No_type,No_type);Type(incrementar_boi) == Cst(No_type,btype(INTEGER,?,?));Type(registrar_valeu_boi) == Cst(No_type,btype(INTEGER,?,?)*etype(STATUS_SENHA,?,?));Type(atualizar_dono) == Cst(No_type,btype(INTEGER,?,?)*btype(INTEGER,?,?)*etype(CATEGORIAS,?,?));Type(atualizar_status) == Cst(No_type,btype(INTEGER,?,?)*etype(STATUS_SENHA,?,?));Type(cadastrar_senha) == Cst(No_type,btype(INTEGER,?,?)*btype(INTEGER,?,?)*etype(CATEGORIAS,?,?)))
END
&
THEORY TCIntRdX IS
  predB0 == OK;
